...
<button class="ze-submit" name="submit" type="submit" id="submit" value="发布评论" aria-label="提交评论"><svg class="size-5" aria-hidden="true"><use xlink:href="<?php echo Ze_Icons; ?>#icon-plane"></use></svg>
</button>
</div>
...
<?php 
$k=0;$grid='ze-input-group';
if (!empty($this->options->tools) && in_array('xurl', $this->options->tools)){$k++;}
if($k==1){$grid='ze-input-group2';}
 ?>
